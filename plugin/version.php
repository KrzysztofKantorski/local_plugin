...
$plugin->version = 2021051712.01;  // YYYYMMDDHH (Year Month Day 24-hr time). // YYYYMMDDHH (The release version of Moodle 4.1).
$plugin->component = 'local_plugin'; // Name of your plugin (used for diagnostics).

...
//$data = new stdClass();
//$data->name = 'nnn';
//$id = $DB->insert_record('local_plugin', $data);
$filename = 'users.csv';
...
while (($data = fgetcsv($file)) !== false) {
   ...
   $user->employee_number = $data[4];
    $user->organizational_unit = $data[5];
    $user->position = $data[6];
    $dbman = $DB->get_records('user');
    echo "<td>".$user->username."</td>";
    echo "<td>".$user->email."</td>";
    echo "<td>".$user->firstname."</td>";
    echo "<td>".$user->lastname."</td>";
    echo "<td>".$user->employee_number."</td>";
    echo "<td>".$user->organizational_unit."</td>";
